...
/**
* koordinator/monitor/_MonitorStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Koordinator.idl
* Dienstag, 6. Mai 2014 11:00 Uhr MESZ
*/

public class _MonitorStub extends org.omg.CORBA.portable.ObjectImpl implements koordinator.monitor.Monitor
{
  ...
  public void ring (String[] prozessIds)
  {
            ...
            try {
                ...
                koordinator.monitor.ProzessIdsHelper.write ($out, prozessIds);
                $in = _invoke ($out);
                return;
  ...
  public void startzahlen (int[] startzahlen)
  {
            ...
            try {
                ...
                koordinator.monitor.StartzahlenHelper.write ($out, startzahlen);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
