...
public class Sensor {
    ...
    protected void initDisplays(String[] displays) throws DisplayNichtBekanntException {
        ...
        for (int i = 0; i < displays.length; i++) {
            try {
                ...
                throw new DisplayNichtBekanntException(displays[i] + "nicht bekannt!");
            }
    ...
    public synchronized void anmelden(@WebParam(name = "sensor_id") String sensor_id, @WebParam(name = "display_id") String[] display_id)
        ...
        for (int i = 0; i < display_id.length; i++) {
            ...
            // else {
            // this.map_lock.unlock();
            // throw new DisplayNichtBekanntException(display_id[i] +
            // " : nicht bekannt!");
            // }
        }
    ...
    protected void updateSensorMap(String sensor_id, String[] display_id, boolean add) {
    ...
    public void removeSensor(@WebParam(name = "sensor_id") String sensor_id, @WebParam(name = "display_id") String[] display_id) {
        if (!this.sensor_id.equals(koordinator_id)) {
            stopWahlTimer();
            startWahlTimer();
        }
    ...
    private void updateDisplaysBelegung(String display_id[], boolean value) {
        for (int i = 0; i < display_id.length; i++) {
