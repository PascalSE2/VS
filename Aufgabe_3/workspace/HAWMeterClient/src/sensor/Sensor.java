...
public class Sensor {
    private final String DEFAULT_DISPLAY_IP = "http://0.0.0.0:9999/hawmetering/";
...
//    protected void initDisplays(String display_url) {
...
//            try {
//                location = new URL(DEFAULT_DISPLAY_IP + names[i]);
...
//
//                display_service_map.put(DEFAULT_DISPLAY_IP + names[i], display);
//            } catch (MalformedURLException e) {
//                e.printStackTrace();
//            }catch (Exception e) {
//                System.out.println(DEFAULT_DISPLAY_IP + names[i] + " Existiert nicht!");
//            }
//            this.display_belegung.put(DEFAULT_DISPLAY_IP + names[i], false);
//        }
//    }
