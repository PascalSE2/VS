...
/**
* koordinator/monitor/MonitorPOA.java .
...
public abstract class MonitorPOA extends org.omg.PortableServer.Servant
 implements koordinator.monitor.MonitorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  /*
       ...
       */
       case 0:  // koordinator/monitor/Monitor/ring
       {
         String prozessIds[] = koordinator.monitor.ProzessIdsHelper.read (in);
  ...
  /*
       ...
       */
       case 1:  // koordinator/monitor/Monitor/startzahlen
       {
         int startzahlen[] = koordinator.monitor.StartzahlenHelper.read (in);
  ...
  /*
       ...
       */
       case 2:  // koordinator/monitor/Monitor/rechnen
       {
  ...
  /*
       ...
       */
       case 3:  // koordinator/monitor/Monitor/terminieren
       {
         String prozessId = in.read_string ();
         String prozessIdAbsender = in.read_string ();
  ...
  /*
       ...
       * Monitor uebergeben.
       */
       case 4:  // koordinator/monitor/Monitor/ergebnis
       {
         String prozessId = in.read_string ();
         int num = in.read_long ();
